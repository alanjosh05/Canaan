      ...
      <div className="relative rounded-2xl overflow-hidden bg-white grid grid-cols-1 sm:grid-cols-2 min-h-[560px]">
        ...
        <div className="relative min-h-[320px] sm:min-h-0">
          ...
          <div className="absolute bottom-0 left-0 bg-[#f5f4f0] px-5 py-3 rounded-tr-2xl z-10">
            <span className="text-[10px] font-medium tracking-[0.1em] uppercase text-[#85660c]">
              Founder &amp; CEO
            </span>
          </div>
        </div>
        ...
        <div className="bg-[#f5f4f0] flex flex-col justify-between">
          ...
          <div className="flex flex-col gap-5 px-7 py-6 flex-1">
            ...
            <div>
              ...
              <h2 className="text-4xl font-bold tracking-[-0.03em] leading-[1.1] text-[#0a0908]">
                Arun <span className="italic font-normal text-[#85660c]">Sam Alfred</span>
              </h2>
            </div>

            <div className="text-[11px] font-medium tracking-[0.08em] uppercase text-[#85660c] border-l-2 border-neutral-200 pl-3">
            ...
            <div className="bg-white rounded-xl px-5 py-4">
              ...
              <p className="font-serif italic text-[15px] text-[#85660c] leading-relaxed">
            ...
            <div className="flex flex-col gap-0.5">
              <span className="text-[13px] font-semibold text-[#0a0908]">15+ years of logistics expertise</span>
              <span className="text-[11px] text-neutral-400">50,000+ shipments · 30+ countries</span>
            </div>
            {/* <button className="flex items-center gap-2 bg-[#0a0908] text-white text-[12px] font-semibold px-4 py-2 rounded-full hover:bg-neutral-700 transition-colors">
