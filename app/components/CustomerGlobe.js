...
const LABEL_POINTS = [
  ...
  { lat: 36.2, lng: 138.25, label: "Japan" },
...
function makeLabelEl(d) {
  ...
  dot.style.cssText = `
    ...
    border-radius: 50%;
    background: ${d.isHub ? "#0a0908" : "rgba(26,25,22,0.65)"};
  ...
  pill.style.cssText = `
    ...
    color: ${d.isHub ? "#0a0908" : "rgba(26,25,22,0.8)"};
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 sm:right-auto bg-white/90 backdrop-blur-sm px-5 py-5 sm:px-7 sm:py-6 rounded-tr-2xl z-10">
          <h2 className="text-2xl sm:text-3xl lg:text-[2.4rem] font-bold tracking-[-0.03em] leading-[1.18] text-[#0a0908]">
            ...
            <span className="text-[#85660c]"> built from Tuticorin.</span>
          </h2>
        </div>
      </div>
        ...
        >
          ...
          <div className="absolute top-0 right-0 bg-white/90 backdrop-blur-sm px-4 py-3 sm:px-5 sm:py-4 rounded-bl-2xl z-10">
            {hoveredRoute ? (
              <div className="flex items-center gap-2">
                <span className="text-[11px] font-semibold text-[#0a0908] tracking-tight">
                  {hoveredRoute.from}
                </span>
          ...
          >
            <Globe
              ...
              atmosphereColor="rgba(180,200,220)"
          ...
          <div className="absolute bottom-0 left-0 bg-white/90 backdrop-blur-sm px-4 py-3 sm:px-5 sm:py-4 rounded-tr-2xl z-10">
            <p className="text-[9px] font-medium tracking-[0.1em] uppercase text-[#85660c] mb-0.5">
              Hub
            </p>
            <p className="text-xs font-bold text-[#0a0908] tracking-tight">
              Tuticorin, India
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {STATS.map(({ num, label }, index) => (
              ...
              >
                ...
                <div>
                  <p className="text-2xl font-bold tracking-[-0.04em] text-[#0a0908] leading-none">
                    {num}
                  </p>
                  <p className="text-[10px] font-medium tracking-[0.08em] uppercase text-[#85660c] mt-1">
                    {label}
                  </p>
                </div>
              </div>
          ...
          <div className="relative flex-1 bg-white/80 border border-black/10 rounded-2xl overflow-hidden">
            ...
            {selectedDest && (
              <div className="absolute top-0 right-0 bg-white/90 backdrop-blur-sm px-3 py-2 rounded-bl-2xl z-10">
                <span className="text-[9px] font-medium text-neutral-600 tracking-tight">
                  → {selectedDest}
                </span>
              </div>
            )}
              ...
              {ROUTES.map((r) => {
                ...
                return (
                  <div
                    ...
                    className={`flex items-center justify-between py-2.5 border-b border-black/5 last:border-0 cursor-pointer transition-all duration-200 ${isSelected || isHovered
                        ? "opacity-100"
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <span
                        ...
                        style={{
                          ...
                          color: isSelected ? "#0a0908" : "#374151",
                        }}
                      >
                        {r.to}
                      </span>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        borderColor: isSelected ? "#0a0908" : "rgba(0,0,0,0.1)",
                      }}
                    >
                      <ArrowRight
                        size={9}
