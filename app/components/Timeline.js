...
function DesktopTimeline() {
  ...
  const parallaxOffset = useParallax(sectionRef, 0.01);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            background: "linear-gradient(145deg, #0a0908, #2e2b26)",
            borderRadius: 20,
        ...
        >
          ...
          <div style={{ background: "rgba(255,255,255,0.1)", borderRadius: 99, height: 3, overflow: "hidden" }}>
            <div style={{
              ...
              background: "linear-gradient(90deg, #b68f19ff, #1b60c7ff)",
              borderRadius: 99,
            ...
            {MILESTONES.map((_, i) => (
              <div
                ...
                style={{
                  ...
                  background: i === activeIndex ? "#b68f19ff" : "rgba(255,255,255,0.2)",
          ...
          {MILESTONES.map((m, i) => (
            ...
            >
              <div style={{
                ...
                background: i === activeIndex ? "#0a0908" : "#c8c5bc",
                transition: "background 0.25s", flexShrink: 0,
              }} />
              <span style={{
                fontSize: 12,
                fontWeight: i === activeIndex ? 600 : 400,
                color: i === activeIndex ? "#0a0908" : "#a0998c",
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 4 }}>
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background: isActive
              ? "linear-gradient(145deg, #2a2926, #0a0908)"
        ...
        {!isLast && (
          <div style={{
            ...
            background: isActive
              ? "linear-gradient(to bottom, #b68f19ff 0%, #c8c5bc 60%, transparent 100%)"
        ...
        >
          ...
          {isActive && (
            <div style={{
              ...
              background: "linear-gradient(to bottom, #b68f19ff, #1b60c7ff)",
            }} />
          )}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
            ...
            {isActive && (
              <span style={{
                fontSize: 9, background: "linear-gradient(90deg,#b68f19ff,#1b60c7ff)",
          ...
          <h3 style={{
            ...
            color: "#0a0908", margin: "0 0 8px", lineHeight: 1.3,
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", flexShrink: 0 }}>
        <div style={{
          ...
          background: "linear-gradient(145deg, #2a2926, #0a0908)",
      ...
      >
        ...
        <h3 style={{ fontSize: 14, fontWeight: 700, letterSpacing: "-0.02em", color: "#0a0908", margin: "0 0 5px", lineHeight: 1.3 }}>
          {m.title}
        </h3>
          ...
          >
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                lineHeight: 1.15, color: "#0a0908", margin: 0,
              }}>
